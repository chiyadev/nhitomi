    ...
    public class EnglishLocalization : Localization
    {
        ...
        protected override object CreateDefinition() => new
        {
            ...
            helpMessage = new
            {
                ...
                invite =
                    "[Join]({guildInvite}) the official server or [invite nhitomi]({botInvite}) to your server.",
                doujins = new
                {
                    heading  = "Doujinshi",
            ...
            welcomeMessage = new
            {
                ...
                referHelp =
                    "Please refer to `{prefix}help` for a comprehensive list of commands and usage examples.",
