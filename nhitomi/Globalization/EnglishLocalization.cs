    ...
    public class EnglishLocalization : Localization
    {
        ...
        protected override object CreateDefinition() => new
        {
            ...
            messages = new
            {
                ...
                invalidQuery = "**nhitomi**: Query `{query}` is not valid.",
                ...
                alreadyInCollection =
                    "**nhitomi**: Doujin `{doujin.Name}` already exists in collection `{collection.Name}`.",
                notInCollection = "**nhitomi**: Doujin `{doujin.Name}` was not found in collection `{collection.Name}`."
            },
            doujinMessage = new
            {
                title = "{doujin.Name}",
