  ...
  protected async render(locale: Locale): Promise<RenderResult> {
    ...
    return {
      embed: {
        ...
        footer: {
          text: locale.get("get.sources.footer", {
        ...
        fields: Object.entries(
          ...
          .slice(0, 25), // https://discordjs.guide/popular-topics/embeds.html#embed-limits
      },
    };
  }

  protected createTriggers(): ReactionTrigger[] {
    return [...super.createTriggers(), new DestroyTrigger()];
  }
}
...
export class SourcesTrigger extends ReactionTrigger {
  ...
  constructor(readonly target: SourcesTriggerTarget) {
    super();
  }
