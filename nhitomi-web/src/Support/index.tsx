...
import { SupportDescription, MainCard, ThanksDescription } from './MainCard'
      ...
      {useMemo(() => (
        <MainCard>
          <div className='space-y-4'>
            <div>
              <HeartFilled className={cx('text-4xl text-pink mr-2', css`transform: rotate(20deg);`)} />

              <FormattedMessage id={supporter ? 'pages.support.subtitle_supporter' : 'pages.support.subtitle'} values={{
