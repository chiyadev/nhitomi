...
export const ThanksDescription = () => {
  ...
  return (
    <div className='space-y-2'>
      <div>You are supporting nhitomi for <strong className='text-pink'>{months} months</strong> and have contributed <strong className='text-pink'>{spending} USD</strong> in total. Your supporter period ends in <strong className='text-pink'>{expireDays} days</strong>.</div>
