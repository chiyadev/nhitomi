...
export const TagDisplay = ({ tag, value, ...props }: { tag: keyof typeof TagLabels, value: string } & ComponentProps<typeof Tag>) =>
...
export const CategoryDisplay = ({ category, ...props }: { category: keyof typeof CategoryLabels } & ComponentProps<typeof Tag>) =>
...
export const MaterialRatingDisplay = ({ rating, ...props }: { rating: MaterialRating } & ComponentProps<typeof Tag>) =>
