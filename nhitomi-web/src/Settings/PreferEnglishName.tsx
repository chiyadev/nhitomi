...
export const PreferEnglishName = () => {
  ...
  return (
    <SettingsFocusContainer focus="preferEnglishName">
      <div>
        <FormattedMessage id="pages.settings.reader.preferEnglishName.name" />
      </div>
      <div className="text-sm text-gray-darker">
        <FormattedMessage id="pages.settings.reader.preferEnglishName.description" />
      </div>
      <br />

      <CheckBox value={preferEnglishName} setValue={setPreferEnglishName}>
        {preferEnglishName ? (
